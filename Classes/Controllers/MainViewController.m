...
//        _ShareSDKLoading = NO;
        ...
        id<ISSCAttachment> imageShare = [ShareSDK jpegImageWithImage:[UIImage imageNamed:@"icon@2x.png"] quality:1.0];
...
//        }
        ...
        [publishContent addSinaWeiboUnitWithContent:contentWeibo image:imageShare];
        
        imageShare = [ShareSDK jpegImageWithImage:[UIImage imageNamed:@"icon.png"] quality:1.0];
        
        [publishContent addWeixinSessionUnitWithType:[NSNumber numberWithInteger:SSPublishContentMediaTypeNews] content:content title:@"语音笑话网" url:url image:imageShare musicFileUrl:nil extInfo:nil fileData:nil emoticonData:nil];
        [publishContent addWeixinTimelineUnitWithType:[NSNumber numberWithInteger:SSPublishContentMediaTypeNews] content:content title:[NSString stringWithFormat:@"语音笑话网：%@",_jokeViewController.jokeModel.title] url:url image:imageShare musicFileUrl:nil extInfo:nil fileData:nil emoticonData:nil];
